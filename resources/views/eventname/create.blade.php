<form id="createEventForm">
  <div class="row mb-2">
    <div class="col">
      <label for="code" title="{{ $tableComments['code'] }}"><b>{{ __('Code') }}</b></label>
    ...
    <div class="col p-2 btn-group">
      ...
      <label class="btn btn-outline-primary" for="btn-istask" title="{{ $tableComments['is_task'] }}">{{ __('Task') }}</label>
    </div>
  </div>
  <div class="row mb-2">
    <div class="col">
      <label for="name" title="{{ $tableComments['name'] }}"><b>{{ __('Name') }}</b></label>
      <input type="text" class="form-control" name="name">
    </div>
    <div class="col p-2 btn-group">
      <input class="btn-check" type="radio" id="btn-nostatus" name="status_event" value="0" checked>
      <label class="btn btn-outline-primary" for="btn-nostatus">{{ __('Normal') }}</label>
      <input class="btn-check" type="radio" id="btn-isstatus" name="status_event" value="1">
      <label class="btn btn-outline-primary" for="btn-isstatus" title="{{ $tableComments['status_event'] }}">{{ __('Status') }}</label>
    </div>
  </div>
  <div class="row mb-2">
    <div class="col">
      <label title="{{ $tableComments['default_responsible'] }}">{{ __('Default responsible') }}</label>
    ...
    <div class="col">
      <label title="{{ $tableComments['use_matter_resp'] }}">{{ __('Use matter responsible') }}</label>
  ...
  <div class="row mb-2">
    <div class="col">
      <label for="country" title="{{ $tableComments['country'] }}">{{ __('Country') }}</label>
      <input type='hidden' name='country'>
      <input type="text" class="form-control" data-ac="/country/autocomplete" data-actarget="country"
        autocomplete="off">
    </div>
    <div class="col">
      <label for="category" title="{{ $tableComments['category'] }}">{{ __('Category') }}</label>
  ...
  <div class="row mb-2">
    <div class="col">
      <label for="notes" title="{{ $tableComments['notes'] }}">{{ __('Notes') }}</label>
