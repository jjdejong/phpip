	...
	<fieldset class="ename-info-set">
		...
		<table data-id="{{ $enameInfo->code }}" data-source="/eventname/">
                <tr><td><label>Code</label>
                        ...
                        <input type="radio" class="noformat" name="is_task" id="is_task" value="1" {{ $enameInfo->is_task ? 'checked="checked"' : "" }} />Yes&nbsp;&nbsp;
                        <input type="radio" class="noformat" name="is_task" id="is_task" value="0" {{ $enameInfo->is_task ? "" : 'checked="checked"'}} />No
                </span>
                        ...
                        <input type="radio" class="noformat" name="status_event" id="status_event" value="1" {{ $enameInfo->status_event ? 'checked="checked"' : "" }} />Yes&nbsp;&nbsp;
                        <input type="radio" class="noformat" name="status_event" id="status_event" value="0" {{ $enameInfo->status_event ? "" : 'checked="checked"'}} />No
                </span>
                        ...
                        <input type="radio" class="noformat" name="use_matter_resp" id="use_matter_resp" value="1" {{ $enameInfo->use_matter_resp ? 'checked="checked"' : "" }} />Yes&nbsp;&nbsp;
                        <input type="radio" class="noformat" name="use_matter_resp" id="use_matter_resp" value="0" {{ $enameInfo->use_matter_resp ? "" : 'checked="checked"'}} />No
                </span>
                        ...
                        <input type="radio" class="noformat" name="unique" id="unique" value="1" {{ $enameInfo->unique ? 'checked="checked"' : "" }} />Yes&nbsp;&nbsp;
                        <input type="radio" class="noformat" name="unique" id="unique" value="0" {{ $enameInfo->unique ? "" : 'checked="checked"'}} />No
                </span>
                        ...
                        <input type="radio" class="noformat" name="uqtrigger" id="uqtrigger" value="1" {{ $enameInfo->uqtrigger ? 'checked="checked"' : "" }} />Yes&nbsp;&nbsp;
                        <input type="radio" class="noformat" name="uqtrigger" id="uqtrigger" value="0" {{ $enameInfo->uqtrigger ? "" : 'checked="checked"'}} />No
                </span>
				...
				<td><label for="killer" title="{{ $tableComments['killer'] }}">Is killer</label>
                        ...
                        <input type="radio" class="noformat" name="killer" id="killer" value="1" {{ $enameInfo->killer ? 'checked="checked"' : "" }} />Yes&nbsp;&nbsp;
                        <input type="radio" class="noformat" name="killer" id="killer" value="0" {{ $enameInfo->killer ? "" : 'checked="checked"'}} />No
                </span>
                </tr>
			</table>
