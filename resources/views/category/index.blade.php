...
<div class="page-header">
  <div class="d-flex justify-content-between align-items-center">
    <h1 class="h4 mb-0">{{ __('Categories') }}</h1>
    <div class="page-actions">
      <a href="category/create" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ajaxModal" title="{{ __('Category') }}" data-resource="/category/">
