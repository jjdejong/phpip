<form id="createCategoryForm">
  <fieldset>
    <table class="table table-sm">
      <tr>
        <td><label for="code" title="{{ __($tableComments['code']) }}"><b>{{ _i("Code")}}</b></label></td>
        <td><input type="text" class="form-control form-control-sm" name="code"></td>
        <td><label for="category" title="{{ __($tableComments['category']) }}"><b>{{ _i("Category name")}}</b></label></td>
        <td><input type="text" class="form-control form-control-sm" name="category"></td>
      </tr>
      <tr>
        <td><label for="ref_prefix" title="{{ __($tableComments['ref_prefix']) }}">{{ _i("Reference prefix")}}</label></td>
        <td><input type="text" class="form-control form-control-sm" name="ref_prefix"></td>
        <td><label for="display_with" title="{{ __($tableComments['display_with']) }}"><b>{{ _i("Display with")}}</b></label></td><td>
