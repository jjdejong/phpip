<form id="createRuleForm">
  <fieldset>
    ...
    <table class="table table-sm">
      ...
      <tr>
        <td><label for="for_country_new" title="{{ $ruleComments['for_country'] }}">{{ __('Country') }}</label></td>
        <td>
  ...
  <fieldset>
    ...
    <table class="table table-sm">
      ...
      <tr>
        <td><label for="abort_on_new" title="{{ $ruleComments['abort_on'] }}">{{ __('Abort if') }}</label></td>
        <td>
  ...
  <button type="button" class="btn btn-primary" id="createRuleSubmit" data-redirect="/rule">{{ __('Create rule') }}</button><br>
</form>
