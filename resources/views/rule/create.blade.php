...
<form id="createRuleForm">
	<fieldset>
		...
		<table class="table table-sm table-hover">
                <tr><td><label for="task" title="{{ $ruleComments['task'] }}">Task</label> 
                </td><td class="ui-front"><input class="rule-input-wide noformat" name="task_new" >
					<input type='hidden' name='task' id='task' >
                		...
                		<input type="text" class="rule-input-wide noformat" name="for_country_new">
                		...
                		<input class="rule-input-wide noformat" name="for_origin_new">
						...
						<input class="rule-input-narrow noformat" name="for_category_new">
					...
					<input class="rule-input-narrow noformat" name="for_type_new" >
        ...
        <fieldset>
                ...
                <tr><td><label for="trigger_event_new" title="{{ $ruleComments['trigger_event'] }}">Trigger event</label>
					...
					<input class="rule-input-wide noformat" name="trigger_event_new">
					<input type='hidden' name='trigger_event' id='trigger_event' >
						...
						<input class="rule-input-wide noformat" name="condition_event_new">
						...
						<input class="rule-input-wide noformat" name="abort_on_new">
						...
						<input type='text' class="rule-input-narrow noformat" name="responsible_new">
