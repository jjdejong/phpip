<div class="card reload-part" style="height: 480px;">
  ...
  <div class="tab-content" data-resource="/rule/{{ $ruleInfo->id }}">
    <fieldset class="tab-pane fade show active" id="ruleMain">
      <table class="table">
        <tr>
          <th><label class="required-field" title="{{ __($ruleComments['task']) }}">{{ __('Task') }}</label></th>
        ...
        <tr>
          <th><label title="{{ __($ruleComments['trigger_event']) }}">{{ __('Triggered by') }}</label></th>
        ...
        <tr>
          <th><label title="{{ __($ruleComments['detail']) }}">{{ __('Detail') }}</label></th>
          <td><input class="form-control noformat" name="detail" value="{{ $ruleInfo->detail }}"></td>
        </tr>
        <tr>
          <th><label title="{{ __($ruleComments['for_category']) }}">{{ __('Category') }}</label></th>
        ...
        <tr>
          <th><label title="{{ __($ruleComments['for_country']) }}">{{ __('Country') }}</label></th>
        ...
        <tr>
          <th><label title="{{ __($ruleComments['for_origin']) }}">{{ __('Origin') }}</label></th>
    ...
    <fieldset class="tab-pane fade" id="ruleConditions">
      <table class="table">
        <tr>
          <th colspan="2"><label title="{{ __($ruleComments['trigger_event']) }}">{{ __('Triggered by') }}</label></th>
        ...
        <tr>
          <th><label title="{{ __($ruleComments['abort_on']) }}">{{ __('Abort if') }}</label></th>
        ...
        <tr>
          <th><label title="{{ __($ruleComments['responsible']) }}">{{ __('Responsible') }}</label></th>
        ...
        <tr>
          <th><label title="{{ __($ruleComments['use_before']) }}">{{ __('Use before') }}</label></th>
          <td colspan="3"><input type="date" class="form-control noformat" name="use_before" value="{{ $ruleInfo->use_before }}"></td>
        </tr>
        <tr>
          <th><label title="{{ __($ruleComments['use_after']) }}">{{ __('Use after') }}</label></th>
    ...
    <fieldset class="tab-pane fade" id="ruleCost">
      <table class="table">
        <tr>
          <th><label title="{{ __($ruleComments['cost']) }}">{{ __('Cost') }}</label></th>
          <td><input class="form-control noformat" name="cost" value="{{ $ruleInfo->cost }}"></td>
        </tr>
        <tr>
          <th><label title="{{ __($ruleComments['fee']) }}">{{ __('Fee') }}</label></th>
          <td><input class="form-control noformat" name="fee" value="{{ $ruleInfo->fee }}"></td>
        </tr>
        <tr>
          <th><label title="{{ __($ruleComments['currency']) }}">{{ __('Currency') }}</label></th>
