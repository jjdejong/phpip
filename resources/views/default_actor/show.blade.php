<div data-resource="/default_actor/{{ $default_actor->id }}">
  <table class="table">
    <tr>
      <th width="15%"><label title="{{ $tableComments['actor_id'] }}">Actor</label></th>
      ...
      <th><label title="{{ $tableComments['role'] }}">Role</label></th>
    ...
    <tr>
      <th><label title="{{ $tableComments['for_country'] }}">Country</label></th>
    ...
    <tr>
      ...
      <th><label title="{{ $tableComments['shared'] }}">Shared</label></th>
