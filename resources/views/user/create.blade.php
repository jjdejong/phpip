<form id="createUserForm" autocomplete="off">
  <table class="table table-borderless">
    ...
    <tr>
      <td>
				<label title="{{ $userComments['password'] }}">Password (min 8 characters)</label>
    ...
    <tr>
      <td>
				<label title="{{ $userComments['default_role'] }}">Role *</label>
      ...
      <td>
				<label title="{{ $userComments['company_id'] }}">Company</label>
