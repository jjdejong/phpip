<form id="createUserForm">
		<div class="row mb-2">
			<div class="col">
				<label class="fw-bolder" title="{{ __($userComments['name']) }}">{{ __('Name') }}</label>
			...
			<div class="col">
				<label class="fw-bolder" title="{{ __($userComments['login']) }}">{{ __('Login') }}</label>
		...
		<div class="row mb-2">
			...
			<div class="col">
				<label title="{{ __('Select user\'s company') }}">Company</label>
