<table class="table table-hover table-sm">
    ...
    <tbody id="sortable">
        ...
        <tr class="reveal-hidden" id="{{ $actor_item->id }}" data-id="{{ $actor_item->id }}">
            ...
            <td class="ui-front"><input type="text" class="form-control noformat" name="actor_id" placeholder="{{ $actor_item->display_name }}"></td>
            <td><input type="text" class="form-control noformat" name="actor_ref" value="{{ $actor_item->actor_ref }}"></td>
            <td class="ui-front"><input type="text" class="form-control noformat" name="company_id" value="{{ $actor_item->company }}"></td>
