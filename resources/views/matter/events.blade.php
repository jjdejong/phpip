<table class="table table-hover table-sm">
  ...
  <tbody id="eventList">
    ...
    <tr data-id="{{ $event->id }}">
      ...
      <td class="ui-front"><input type="text" class="form-control noformat" size="10" name="alt_matter_id" data-ac="/matter/autocomplete" value="{{ $event->altMatter ? $event->altMatter->uid : '' }}"></td>
    </tr>
    @endforeach
  </tbody>
</table>
