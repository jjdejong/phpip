    ...
    <div class="card-body">
        <form>
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    @if($cat_edit == 1)
                        <select name="category_code" id="category_code"  class="form-control form-control-sm noformat">
                        @foreach ( $cats as $cat )
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4 ui-front">
                    <input type="text" class="form-control form-control-sm noformat" id="origin" name="origin"
                        value="{{  empty($matter->originInfo) ? '' : $matter->originInfo->name  }}">
                </div>
                <label for="type_code" class="col-sm-2 col-form-label">Type</label>
                <div class="col-sm-4">
                    <select name="type_code" id="type_code" class="form-control form-control-sm noformat" >
                        <option value=""></option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control form-control-sm noformat" id="caseref" name="caseref"
                        value="{{ $matter->caseref }}">
                </div>
                <label for="responsible" class="col-sm-2 col-form-label">Responsible</label>
                <div class="col-sm-4 ui-front">
                    <input type="text" class="form-control form-control-sm noformat" id="responsible" name="responsible"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4 ui-front">
                    <input type="text" class="form-control form-control-sm noformat" id="parent_id" name="parent_id"
                        value="{{ empty($matter->parent) ? '' : $matter->parent->UID }}">
                </div>
                <label for="container_id" class="col-sm-2 col-form-label">Container</label>
                <div class="col-sm-4 ui-front">
                    <input type="text" class="form-control form-control-sm noformat" id="container_id" name="container_id"
            ...
            <div class="form-group row" data-id={{ $matter->id }}>
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control form-control-sm noformat" id="idx" name="idx"
                        value="{{ $matter->idx }}">
                </div>
            ...
            <div class="form-group row" data-id={{ $matter->id }}>
                ...
                <div class="col-sm-4">
                    <input type="text" class="form-control form-control-sm noformat" id="term_adjust" name="term_adjust"
