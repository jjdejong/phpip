          ...
          <tbody>
            ...
            <tr  data-id={{ $matter->id }}>
              <td>
                ...
                <td>
                <div>
                    <input type="text" class="form-control-plaintext noformat" id="caseref" name="caseref"
            ...
            <tr data-id={{ $matter->id }}>
                ...
                <td>
                <div>
                    <input type="text" class="form-control-plaintext noformat" id="idx" name="idx"
                        value="{{ $matter->idx }}">
                </div>
                </td>
                <td>Term adjust</td>
                <td>
                    <div>
                        <input type="text" class="form-control-plaintext noformat" id="term_adjust" name="term_adjust"
