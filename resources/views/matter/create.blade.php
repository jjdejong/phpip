<form id="createMatterForm" autocomplete="off" class="ui-front">
  ...
  <div class="form-group row">
    ...
    <div class="col-9">
      ...
      <input type="text" class="form-control" list="ajaxDatalist" data-ac="/category/autocomplete" data-actarget="category_code" placeholder="{{ $category['name'] ?? ( $from_matter->category->category ??  '' ) }}" autocomplete="off">
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-9">
      ...
      <input type="text" class="form-control" list="ajaxDatalist" data-ac="/country/autocomplete" data-actarget="country" placeholder="{{ $from_matter->countryInfo->name ?? '' }}" autocomplete="off">
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-9">
      ...
      <input type="text" class="form-control" list="ajaxDatalist" data-ac="/country/autocomplete" data-actarget="origin" placeholder="{{ $from_matter->originInfo->name ?? '' }}" autocomplete="off">
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-9">
      ...
      <input type="text" class="form-control" list="ajaxDatalist" data-ac="/type/autocomplete" data-actarget="type_code" placeholder="{{ $from_matter->type->type ?? '' }}" autocomplete="off">
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-9">
      ...
      @else
      <input type="text" class="form-control" list="ajaxDatalist" data-ac="/matter/new-caseref" name="caseref" value="{{ $from_matter->caseref ?? ( $category['next_caseref'] ?? '') }}" autocomplete="off">
      @endif
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-9">
      ...
      <input type="text" class="form-control" list="ajaxDatalist" data-ac="/user/autocomplete" data-actarget="responsible" placeholder="{{ $from_matter->responsible ?? Auth::user()->name }}" autocomplete="off">
    </div>
  </div>
