<form id="createMatterForm" autocomplete="off" class="ui-front">
  ...
  <div class="form-group row">
    <label for="category" class="col-4 col-form-label font-weight-bold">{{ _i("Category") }}</label>
    <div class="col-8">
  ...
  @if ( $operation == 'ops' )
  <div class="form-group row">
    <label for="docnum" class="col-4 col-form-label font-weight-bold">{{ _i("Pub Number") }}</label>
    <div class="col-8">
  ...
  <div class="form-group row">
    <label for="client_id" class="col-4 col-form-label font-weight-bold">{{ _i("Client") }}</label>
    <div class="col-8">
  ...
  <div class="form-group row">
    <label for="country" class="col-4 col-form-label font-weight-bold">{{ _i("Country") }}</label>
    <div class="col-8">
  ...
  <div class="form-group row">
    <label for="origin" class="col-4 col-form-label">{{ _i("Origin") }}</label>
    <div class="col-8">
  ...
  <div class="form-group row">
    <label for="type_code" class="col-4 col-form-label">{{ _i("Type") }}</label>
    <div class="col-8">
  ...
  @endif
  <div class="form-group row">
    <label for="caseref" class="col-4 col-form-label font-weight-bold">{{ _i("Caseref") }}</label>
    <div class="col-8">
      @if ( $operation == 'child' )
  ...
  <div class="form-group row">
    <label for="responsible" class="col-4 col-form-label font-weight-bold">{{ _i("Responsible") }}</label>
    <div class="col-8">
  ...
  <div>
    @if ( $operation == 'ops' )
    <button type="button" id="createFamilySubmit" class="btn btn-primary btn-block">{{ _i("Create") }}</button>
    @else
    <button type="button" id="createMatterSubmit" class="btn btn-primary btn-block">{{ _i("Create") }}</button>
    @endif
  </div>
</form>
