<form id="createMatterForm" autocomplete="off" class="ui-front">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <input type="text" class="form-control" data-ac="/category/autocomplete" data-actarget="category_code" placeholder="{{ $category['name'] ?? ( $parent_matter->category->category ??  '' ) }}" autocomplete="off">
    </div>
  </div>
  <div class="form-group row">
