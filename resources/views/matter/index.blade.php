    ...
    <table class="table table-striped table-hover table-sm mb-1">
      <thead>
        <tr id="filterFields">
          ...
          <td class="tab1 {{ $hideTab1 }}"><input class="form-control" name="FilNo" placeholder="{{ __('Number') }}" value="{{ Request::get('FilNo') }}"></td>
          <td class="tab1 {{ $hideTab1 }}">
            <div class="input-group input-group-sm">
          ...
          <td class="tab1 {{ $hideTab1 }}"><input class="form-control" name="{{ __('PubNo') }}" placeholder="Number" value="{{ Request::get('PubNo') }}"></td>
          <td class="tab1 {{ $hideTab1 }}">
            <div class="input-group input-group-sm">
              <input class="form-control" name="Granted" placeholder="{{ __('Granted') }}" value="{{ Request::get('Granted') }}">
