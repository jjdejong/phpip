...
<legend class="alert alert-dark d-flex justify-content-between py-2 mb-1">
  {{ __('Matter Types') }}
  <a href="type/create" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ajaxModal" title="{{ __('Type') }}" data-resource="/type/">{{ __('Create Matter Type') }}</a>
</legend>
<div class="row">
  <div class="col">
      ...
      <table class="table table-striped table-hover table-sm">
        <thead>
          <tr id="filter" class="table-primary align-middle">
            <th><input class="form-control" data-source="/type" name="Code" placeholder="{{ __('Code') }}"></th>
            <th><input class="form-control" data-source="/type" name="Type" placeholder="{{ __('Type') }}"></th>
          </tr>
        </thead>
        <tbody id="tableList">
