...
<div id="edit-actor-content">
	<fieldset>
		...
		<table class="table table-hover table-sm" data-id="{{ $actorInfo->id }}">
                ...
                </td><td class="ui-front"><input class="editable form-control form-control-sm" name="name" value="{{ $actorInfo->name }}">
                </td><td><label for="first_name" title="{{ $actorComments['first_name'] }}">First name</label>
                </td><td><input id="first_name" class="editable form-control form-control-sm" name="first_name" value="{{ $actorInfo->first_name }}">
                </tr><tr><td><label for="display_name" title="{{ $actorComments['display_name'] }}">Display name</label>
                </td><td class="ui-front">
                		<input type="text" class="editable form-control form-control-sm" name="display_name" value="{{ $actorInfo->display_name }}">
                </td><td><label for="login" title="{{ $actorComments['login'] }}">Login</label>
                </td><td><input id="login" class="editable form-control form-control-sm" name="login" value="{{ $actorInfo->login }}">
                </tr><tr><td><label for="default_role" title="{{ $actorComments['default_role'] }}">Default role</label>
                </td><td class="ui-front">
                		<input type="text" class="form-control form-control-sm" name="default_role" value="{{ empty($actorInfo->droleInfo) ? '' : $actorInfo->droleInfo->name }}">
                </td><td><label for="function" title="{{ $actorComments['function'] }}">Function</label>
                </td><td><input id="function" class="editable form-control form-control-sm" name="function" value="{{ $actorInfo->function }}">
                </tr><tr><td><label for="company_id" title="{{ $actorComments['company_id'] }}">Employer</label>
                </td><td class="ui-front">
                		<input type="text" class=" form-control form-control-sm" id="company_id" name="company_id" value="{{ empty($actorInfo->company) ? '' : $actorInfo->company->name }}">
                <td><label for="parent_id" title="{{ $actorComments['parent_id'] }}">Parent company</label>
                </td><td class="ui-front">
                		<input type="text" class=" form-control form-control-sm" id="parent_id" name="parent_id" value="{{ empty($actorInfo->parent) ? '' : $actorInfo->parent->name }}">
                </tr><tr><td><label for="site_id" title="{{ $actorComments['site_id'] }}">Work site</label>
                </td><td class="ui-front">
                		<input type="text" class=" form-control form-control-sm" id="site_id" name="site_id" value="{{ empty($actorInfo->site) ? '' : $actorInfo->site->name }}">
                		...
                		<input type="text" class="form-control form-control-sm" name="nationality" value="{{ empty($actorInfo->nationalityInfo) ? '' : $actorInfo->nationalityInfo->name }}">
              ...
              <table class="table table-hover table-sm" data-id="{{ $actorInfo->id }}">
                <tr><td><label for="address" title="{{ $actorComments['address'] }}">Address</label><br />
					...
					<input type='text' class="editable form-control form-control-sm" name="email" value="{{ $actorInfo->email }}">
						...
						<input type='text' class="editable form-control form-control-sm" name="phone" value="{{ $actorInfo->phone }}">
				</td></tr>
			</table>
        </fieldset>
        <fieldset>
