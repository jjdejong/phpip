<form id="createActorForm">
    ...
    <table class="table table-borderless">
      <tr>
        <td><label for="name" class="required-field" title="{{ __($actorComments['name']) }}">{{ __("Name *") }}</label></td>
        <td><input class="form-control" name="name" placeholder="{{ __('NAME Firstname') }}"></td>
        <td><label for="first_name" title="{{ __($actorComments['first_name']) }}">{{ __("First name") }}</label></td>
      ...
      <tr>
        ...
        <td><input type="text" class="form-control" name="display_name"></td>
				<td><label for="company_id" title="{{ __($actorComments['company_id']) }}">{{ __("Employer") }}</label></td>
        <td>
      ...
      <tr>
        <td><label for="default_role" title="{{ __($actorComments['default_role']) }}">{{ __("Default role") }}</label></td>
        <td>
        ...
        <td><label for="function" title="{{ __($actorComments['function']) }}">{{ __("Function") }}</label></td>
